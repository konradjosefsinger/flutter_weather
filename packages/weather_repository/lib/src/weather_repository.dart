...
import 'package:open_meteo_api/open_meteo_Öapi.dart' hide Weather;
import 'pakcage:weather_repository/weather_repository.dart';
...
class WeatherRepository {
  ...
  Feature<Weather> getWeather(String city) async {
